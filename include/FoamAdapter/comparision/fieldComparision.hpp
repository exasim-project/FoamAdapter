...
#define FIELD_EQUALITY_OPERATOR(NFIELD_TYPE, FFIELD_TYPE)                      \
  bool operator==(NeoFOAM::Field<NFIELD_TYPE> &nfield,                         \
                  const Foam::Field<FFIELD_TYPE> &ffield) {                    \
...
#define VOLGEOFIELD_EQUALITY_OPERATOR(NFIELD_TYPE, FFIELD_TYPE)                \
  bool operator==(NeoFOAM::fvccVolField<NFIELD_TYPE> &nfield,                  \
                  const Foam::GeometricField<FFIELD_TYPE, Foam::fvPatchField,  \
                                             Foam::volMesh> &ffield) {         \
...
#define SURFGEOFIELD_EQUALITY_OPERATOR(NFIELD_TYPE, FFIELD_TYPE)               \
  bool operator==(NeoFOAM::fvccSurfaceField<NFIELD_TYPE> &nfield,              \
                  const Foam::GeometricField<FFIELD_TYPE, Foam::fvsPatchField, \
                                             Foam::surfaceMesh> &ffield) {     \
    auto hostSpan = nfield.internalField().copyToHost().field();               \
    const auto &internalFField = ffield.internalField();                       \
