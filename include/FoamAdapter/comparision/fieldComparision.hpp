...
bool operator==(NeoFOAM::fvccVolField<NFIELD_TYPE>& nfield, const Foam::GeometricField<FFIELD_TYPE, Foam::fvPatchField, Foam::volMesh>& ffield) \
{ \
...
bool operator==(NeoFOAM::fvccSurfaceField<NFIELD_TYPE>& nfield, const Foam::GeometricField<FFIELD_TYPE, Foam::fvsPatchField, Foam::surfaceMesh>& ffield) \
{ \
    auto hostSpan = nfield.internalField().copyToHost().field(); \
    const auto& internalFField = ffield.internalField(); \
